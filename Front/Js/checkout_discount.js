        ...
        // console.log(positionProduct);
            // mult = ( med.price - med.price * 0.25 ) * cart.quantity;
                  ...
                  newCart.innerHTML = `<img src="${ info.image }" crossorigin="anonymous">
                    <div class="info">
                    <div class="name">${ info.name }</div>
                    <div class="price">${info.price - info.price *0.25 }SYP /1 medicine <span>With discount</span></div>
                    </div>
                    <div class="quantity">${ cart.quantity }</div>
                    <div class="returnPrice">${(info.price - info.price*0.25)* cart.quantity} SYP</div>`;
